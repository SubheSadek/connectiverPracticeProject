            ...
            <div class="_card _mar_b20">
                ...
                <div class="_num_like_all">
                    ...
                    <div class="_num_like_right">
                        <p class="_num_like_text">0 Comment</p>
                    </div>
                </div>
               ...
               <div class="_1card_comment_box" v-if="commentsInput">
               ...
               <div class="_comment_main" v-if="commentsInput">
